...
<form name="form1" id="form1" method="post" action="">
  <table width="250" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="83">Name</td>
      <td width="417"><input name="name" type="text" id="name" placeholder="Eg.Jhon" /></td>
    </tr>
    <tr> 
      <td>Ph. No.</td>
      <td><input name="phno" type="text" id="phno" value="" placeholder="+91 xxxxx xxxxx"></td>
    </tr>
    
	 <tr> 
      <td>Email</td>
      <td><input name="email" type="text" id="email" value="" placeholder="jhon@gmaial.com"></td>
    </tr>
	 <tr> 
      <td>DOB</td>
      <td><input name="dob" type="date" id="email" value=""></td>
    </tr>
	<tr> 
      <td><input name="save" type="submit" id="save" value="Save" /></td>
      <td><p></p><input type="reset" name="Submit2" value="Reset" /></td>
    </tr>
  </table>
</form>
...
$db->close();
?><a href="phfront.php" target="_blank">back</a>
