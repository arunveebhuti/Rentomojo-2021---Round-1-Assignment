...
<div class="topnav">
  <h2>My Phone Book</h2>
  <input type="text" id="search" name="search" placeholder="Enter name to delete the contact ">
<input name="searchb" type="submit" id="searchb" value="Confirm Delete">
 </div>
...
elseif(isset($_GET['searchb']))
    { 
        $search=$_GET['search'];
        $query="DELETE from phno where name like '$search'";
